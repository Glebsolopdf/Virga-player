...
type Config struct {
	...
	PlayerPosition         PositionPreset    `json:"player_position"`
	PlayerRainLayer        RainLayerMode     `json:"player_rain_layer"`
	LyricsMode             LyricsMode        `json:"lyrics_mode"`
	LyricsDisplayMode      LyricsDisplayMode `json:"lyrics_display_mode"`
	LyricsPosition         PositionPreset    `json:"lyrics_position"`
