...
func decodeConfig(data []byte) (*Config, error) {
	...
	if err := json.Unmarshal(data, &raw); err == nil {
		...
		_, hasPlayerPosition := raw["player_position"]
		_, hasLyricsDisplayMode := raw["lyrics_display_mode"]
		_, hasLyricsPosition := raw["lyrics_position"]
		missingDisplayFields = !hasPlayerPosition || !hasLyricsDisplayMode || !hasLyricsPosition
	}
	...
	cfg.normalize()
	if missingLyricsFields || missingRainLayerFields || missingDisplayFields {
...
func (c *Config) MarshalJSON() ([]byte, error) {
	return json.Marshal(savedConfigJSON{
		...
		LyricsDisplayMode:      c.LyricsDisplayMode,
		LyricsPosition:         c.LyricsPosition,
...
func (c *Config) UnmarshalJSON(data []byte) error {
	...
	c.PlayerPosition = raw.PlayerPosition
	...
	c.LyricsDisplayMode = raw.LyricsDisplayMode
	c.LyricsPosition = raw.LyricsPosition
