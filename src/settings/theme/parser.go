...
func parseThemeCSS(input string, base Theme) Theme {
	...
	colorVars := map[string]*tcell.Color{
		...
		"rain-layer-very-near": &result.RainVeryNear,
		"rain-layer-near":      &result.RainNear,
		"rain-layer-mid":       &result.RainMid,
		"rain-layer-far":       &result.RainFar,
		"rain-layer-very-far":  &result.RainVeryFar,
